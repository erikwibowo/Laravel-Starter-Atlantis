        ...
        <div class="wrapper">
            <div class="main-header">
                ...
                <div class="logo-header" data-background-color="blue">
                    ...
                    <a href="{{ asset('template/admin/index.html') }}" class="logo">
                        <img src="{{ asset('template/admin/assets/img/logo.svg') }}" alt="navbar brand" class="navbar-brand">
                    </a>
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img"> 
                                                        <img src="{{ asset('template/admin/assets/img/jm_denis.jpg') }}" alt="Img Profile">
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img"> 
                                                        <img src="{{ asset('template/admin/assets/img/chadengle.jpg') }}" alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img"> 
                                                        <img src="{{ asset('template/admin/assets/img/mlane.jpg') }}" alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img"> 
                                                        <img src="{{ asset('template/admin/assets/img/talha.jpg') }}" alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img"> 
                                                        <img src="{{ asset('template/admin/assets/img/profile2.jpg') }}" alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
                        ...
                        <ul class="nav nav-primary">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="forms">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ asset('template/admin/forms/forms.html') }}">
                                                <span class="sub-item">Basic Form</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/forms/formvalidation.html') }}">
                                                <span class="sub-item">Form Validation</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/forms/formwidget.html') }}">
                                                <span class="sub-item">Form Widget</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/forms/formwizard.html') }}">
                                                <span class="sub-item">Form Wizard</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/forms/formupload.html') }}">
                                                <span class="sub-item">Multiple Upload</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/forms/formwysiwyg.html') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="tables">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ asset('template/admin/tables/tables.html') }}">
                                                <span class="sub-item">Basic Table</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/tables/datatables.html') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="maps">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ asset('template/admin/maps/googlemaps.html') }}">
                                                <span class="sub-item">Google Maps</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/maps/fullscreenmaps.html') }}">
                                                <span class="sub-item">Full Screen Maps</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/maps/jqvmap.html') }}">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="charts">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="{{ asset('template/admin/charts/charts.html') }}">
                                                <span class="sub-item">Chart Js</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('template/admin/charts/sparkline.html') }}">
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/id.png') }}" alt="indonesia">
                                                                    </div>
                                                                </td>
                                                                <td>Indonesia</td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/us.png') }}" alt="united states">
                                                                    </div>
                                                                </td>
                                                                <td>USA</td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/au.png') }}" alt="australia">
                                                                    </div>
                                                                </td>
                                                                <td>Australia</td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/ru.png') }}" alt="russia">
                                                                    </div>
                                                                </td>
                                                                <td>Russia</td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/cn.png') }}" alt="china">
                                                                    </div>
                                                                </td>
                                                                <td>China</td>
                                                                <td class="text-right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flag">
                                                                        <img src="{{ asset('template/admin/assets/img/flags/br.png') }}" alt="brazil">
                                                                    </div>
                                                                </td>
                                                                <td>Brasil</td>
                                                                <td class="text-right">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="d-flex">
                                            <div class="avatar">
                                                <img src="{{ asset('template/admin/assets/img/logoproduct.svg') }}" alt="..." class="avatar-img rounded-circle">
                                            </div>
                                        ...
                                        <div class="d-flex">
                                            <div class="avatar">
                                                <img src="{{ asset('template/admin/assets/img/logoproduct3.svg') }}" alt="..." class="avatar-img rounded-circle">
                                            </div>
                                            <div class="flex-1 pt-1 ml-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-list">
                                            <div class="item-list">
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/jm_denis.jpg') }}" alt="..." class="avatar-img rounded-circle">
                                                </div>
                                            ...
                                            <div class="item-list">
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/chadengle.jpg') }}" alt="..." class="avatar-img rounded-circle">
                                                </div>
                                                <div class="info-user ml-3">
                                            ...
                                            <div class="item-list">
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/talha.jpg') }}" alt="..." class="avatar-img rounded-circle">
                                                </div>
                                                <div class="info-user ml-3">
                                            ...
                                            <div class="item-list">
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/mlane.jpg') }}" alt="..." class="avatar-img rounded-circle">
                                                </div>
                                                <div class="info-user ml-3">
                                    ...
                                    <div class="quick-scroll scrollbar-outer">
                                        <div class="quick-content contact-content">
                                            ...
                                            <div class="avatar-group">
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/jm_denis.jpg') }}" alt="..." class="avatar-img rounded-circle border border-white">
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/chadengle.jpg') }}" alt="..." class="avatar-img rounded-circle border border-white">
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/mlane.jpg') }}" alt="..." class="avatar-img rounded-circle border border-white">
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('template/admin/assets/img/talha.jpg') }}" alt="..." class="avatar-img rounded-circle border border-white">
                                                </div>
                                                <div class="avatar">
